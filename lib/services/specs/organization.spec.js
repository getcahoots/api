...
describe('The OrganizationService', function suite () {
    ...
    it('should be able to save a new organization', function test (done) {
        ...
        function onSave (err, org) {
            ...
            expect(org.created).to.be(org.modified);
    ...
    it('should be able to update an organization', function test (done) {
        var service = services('organization');
        var organization = {};
        var id = '';
        ...
        function onInsert (err, org) {
            ...
            // Give it a little more time (timestamps should not be equal).
        ...
        function onUpdate (err, org) {
            ...
            expect(org.created).not.to.be(org.modified);
        ...
        service.save(organization, onInsert);
    });
